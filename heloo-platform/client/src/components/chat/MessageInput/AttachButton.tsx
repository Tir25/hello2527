    ...
    return (
        <div className="relative flex-shrink-0">
            ...
            <motion.button
                ...
                className={`p-3 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-full transition-all ${isRecording
                    ? 'bg-gradient-to-r from-red-500 to-orange-500 text-white animate-pulse'
                    : 'bg-white/50 border border-white/30 text-gray-700 hover:bg-white/70 active:bg-white/90 active:scale-95'
