...
export const EmptyState = ({ isSearch, isArchived = false }: EmptyStateProps) => {
    if (isSearch) {
        return (
            <div className="flex flex-col items-center justify-center py-12 text-center px-4">
                ...
                <p className="text-sm font-medium text-gray-700 mb-1">No conversations match your search</p>
    ...
    if (isArchived) {
        return (
            <div className="flex flex-col items-center justify-center py-12 text-center px-4">
                ...
                <p className="text-sm font-medium text-gray-700 mb-1">No archived chats</p>
                <p className="text-xs text-gray-500">Chats you archive will appear here</p>
            </div>
        )
    }
